...
public class CWindow : MonoBehaviour {
    ...
    public Action<int> callback_func = null;
    ...
    public virtual void Show(GameObject _root, Action<int> _callback)
    {
        m_Root = _root;
    ...
    public class CWindowData
    {
        public string strTitle;
        public string strMessage;

        public string strOk;
        public string strCancle;
    }
}
...
/*
    ...
    {
        public override void Show(GameObject _root, Action<int> _callback, string _param = "")
        {
    ...
    // 범용함수.
    public void Show_Window(string _prefab, GameObject _root, Action<int> _callback, string _param = "")
    {
