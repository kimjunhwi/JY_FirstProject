...
public class CWindowOk : CWindow
{
    ...
    public void Show(string _msg, Action<int> _callback)
    {
    ...
    {
        base.Close();
        if (callback_func != null) callback_func(true.GetHashCode());
    ...
    {
        base.Close();
        if (callback_func != null) callback_func(false.GetHashCode());
        Destroy(this.gameObject);
    }
}
...
/*
    ...
    public void Window_notice(string _msq, Action<int> _callback )
    {
