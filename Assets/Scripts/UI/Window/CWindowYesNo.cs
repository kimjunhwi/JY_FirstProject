...
public class CWindowYesNo : CWindow , IPointerDownHandler
{
	...
	public void Show(string _strTitle, string strValue,Sprite _Goods_Sprite, Action<int> _callback)
    {
    ...
    public void OnYes()
    {
        ...
        if (callback_func != null)
            callback_func(true.GetHashCode());
    ...
    public void OnNo()
    {
        ...
        if (callback_func != null)
            callback_func(false.GetHashCode());
